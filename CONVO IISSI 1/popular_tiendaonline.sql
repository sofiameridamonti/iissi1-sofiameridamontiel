...
INSERT INTO Productos (nombre, descripcion, precio, tipoProductoId, puedeVenderseAMenores) VALUES
...
-- Forzamos al Cliente 1 a comprar productos de adultos en el pedido 11
-- Comprará 10 unidades de Videojuegos (ID 4) -> No permitido para menores
INSERT INTO LineasPedido (pedidoId, productoId, unidades, precioUnitario) VALUES
(11, 4, 10, 59.99);

-- Comprará 5 unidades de Películas (ID 7) -> No permitido para menores
INSERT INTO LineasPedido (pedidoId, productoId, unidades, precioUnitario) VALUES
(11, 7, 5, 19.99);

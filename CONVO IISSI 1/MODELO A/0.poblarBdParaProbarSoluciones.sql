...
-- Borrar contenido de las tablas en el orden adecuado
...
('2025-01-01', '2025-01-01', '123 Calle Principal', 'Entregar en la puerta', 1,  1),
('2025-01-02', NULL, '456 Avenida Secundaria', 'Entregar en recepción', 2, NULL),
('2024-06-01', '2010-06-03', '123 Calle VeteTuASaber', 'Cliente con movilidad reducida', 1,  2);
...
-- Insertar un nuevo empleado sin pedidos asociados. Probar que la consulta 2.2. no excluye empleados sin pedidos
INSERT INTO Usuarios (email, contraseña, nombre) VALUES
('empleado_sin_pedidos@example.com', 'password123', 'Empleado Sin Pedidos');

INSERT INTO Empleados (usuarioId, salario) VALUES
((SELECT id FROM Usuarios WHERE email = 'empleado_sin_pedidos@example.com'), 30000.00);
